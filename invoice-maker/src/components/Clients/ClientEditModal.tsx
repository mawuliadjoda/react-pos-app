...
function ClientEditModal() {
  ...
  const handlerClientValue = useCallback((event: any, keyName: any) => {
  ...
  const onChangeImage = useCallback((str: any) => {
  ...
  useEffect(() => {
    if (editedID !== null) {
      setAnimate(true);
      const isFindIndex = clients.findIndex((client: any) => client.id === editedID);
      if (isFindIndex !== -1) {
